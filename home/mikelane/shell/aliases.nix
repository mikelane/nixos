{
  programs.zsh.shellAliases = {
    ...
    vpn-prod-eu = "([[ -f $HOME/workplace/rewst-prod-eu.ovpn ]] || { echo 'VPN configuration file for rewst-prod-eu does not exist.'; exit 1; }) && (aws sts get-caller-identity --profile=rewst-prod-eu > /dev/null 2>&1 || sso rewst-prod-us) && tmux new-session -s awsvpn-eu 'awsvpnclient serve --config /home/mikelane/workplace/rewst-prod-eu.ovpn'";
